  ...
  return (
    <>
      <div className="projects-content ">
        <h2 className="text-4xl font-bold mb-4 pl-2">Projects</h2>
        <div className="grid gap-2 md:grid-cols-2 lg:grid-cols-3">
          ...
          ></Project>
          {/* more */}
          <div className="border border-[var(--border-colour)] rounded-lg flex justify-center items-center h-[200px] bg-[var(--border-colour)] select-none cursor-not-allowed">
