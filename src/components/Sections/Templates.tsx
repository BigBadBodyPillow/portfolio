    ...
    <>
      <div className="templates-content  text-container">
        ...
        <div className="grid gap-2 md:grid-cols-2 lg:grid-cols-3">
          ...
          ></Template>
          {/* more */}
          <div className="border border-(--border-colour) rounded-lg flex justify-center items-center  bg-[rgb(235,235,235)] dark:bg-[rgb(20,20,20)] min-h-2 select-none cursor-not-allowed  z-1">
